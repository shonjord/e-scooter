...
type (
	// Response is responsible to construct an HTTP response.
	Response struct {
...
// UnauthorizedRequest indicates that the request lacks valid authentication credentials.
func (r *Response) UnauthorizedRequest() *Error {
	return &Error{
